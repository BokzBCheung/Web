...
namespace Book.DAL
{
	...
	public partial class V_Outbody_Book
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Book.Model.V_Outbody_Book model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into V_Outbody_Book(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Book.Model.V_Outbody_Book model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update V_Outbody_Book set ");
			strSql.Append("ID=@ID,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from V_Outbody_Book ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Book.Model.V_Outbody_Book GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,BookID,Discount,Num,Total,Price,InHeadID,Name from V_Outbody_Book ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Book.Model.V_Outbody_Book model=new Book.Model.V_Outbody_Book();
		...
		/// 得到一个对象实体
		/// </summary>
		public Book.Model.V_Outbody_Book DataRowToModel(DataRow row)
		{
			Book.Model.V_Outbody_Book model=new Book.Model.V_Outbody_Book();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM V_Outbody_Book ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM V_Outbody_Book ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from V_Outbody_Book T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "V_Outbody_Book";
			parameters[1].Value = "";
