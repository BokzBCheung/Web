...
namespace Match.DAL
{
	...
	public partial class T_Match_Result
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("RID", "T_Match_Result"); 
		}
		...
		public bool Exists(int RID)
		{
			...
			strSql.Append("select count(1) from T_Match_Result");
		...
		public bool Delete(int RID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Match_Result ");
			strSql.Append(" where RID=@RID");
			SqlParameter[] parameters = {
					new SqlParameter("@RID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RID,AID,RInformation ");
			strSql.Append(" FROM T_Match_Result ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" RID,AID,RInformation ");
			strSql.Append(" FROM T_Match_Result ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Match_Result T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_Match_Result";
